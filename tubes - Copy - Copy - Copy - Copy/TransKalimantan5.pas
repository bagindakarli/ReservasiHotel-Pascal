...
begin
        ...
        gotoxy(45,6);write(' T R A N S  K A L I M A N T A N ');
        gotoxy(45,7);write('================================');
                        gotoxy(15,15);write('Total Pesan Pesawat ',a,' : ',arruser[idx].tpesanpesawat[arruser[idx].ttotalpesan].ttotpesanpesawat);
                        gotoxy(15,16);write('+=====+============+=====+=====+============+==========+=====+==============+==============+');
                        gotoxy(15,17);write('| NO. |    NAMA    |  A  |  T  |  TANGGAL   |   JAM    | JML |     HARGA    |     TOTAL    |');
                        gotoxy(15,18);write('+=====+============+=====+=====+============+==========+=====+==============+==============+');
                        y:=1;
                        for i:=1 to arruser[idx].tpesanpesawat[arruser[idx].ttotalpesan].ttotpesanpesawat do
                                begin
...
begin
        ...
        gotoxy(45,6);write(' T R A N S  K A L I M A N T A N ');
        gotoxy(45,7);write('================================');
                        gotoxy(15,15);write('Total Pesan Travel ',a,' : ',arruser[idx].tpesantravel[arruser[idx].ttotalpesan].ttotpesantravel);
                        gotoxy(15,16);write('+=====+============+=====+=====+============+==========+=====+==============+==============+');
                        gotoxy(15,17);write('| NO. |    NAMA    |  A  |  T  |  TANGGAL   |   JAM    | JML |     HARGA    |     TOTAL    |');
                        gotoxy(15,18);write('+=====+============+=====+=====+============+==========+=====+==============+==============+');
                        yy:=1;
                        for o:=1 to arruser[idx].tpesantravel[arruser[idx].ttotalpesan].ttotpesantravel do
                                begin
...
begin
        ...
        arruser[idx].tpesanpesawat[arruser[idx].ttotalpesan].ttotpesanpesawat:=(arruser[idx].tpesanpesawat[arruser[idx].ttotalpesan].ttotpesanpesawat)+1;
...
begin
        ...
        arruser[idx].tpesantravel[arruser[idx].ttotalpesan].ttotpesantravel:=(arruser[idx].tpesantravel[arruser[idx].ttotalpesan].ttotpesantravel)+1;
...
begin
        ...
        repeat
                menu:=readkey;
        until (menu='1') or (menu='2') or (menu=#027);
        write(menu);
        case menu of
                '1':begin
